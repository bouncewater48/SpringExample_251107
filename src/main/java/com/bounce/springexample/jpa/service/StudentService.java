package com.bounce.springexample.jpa.service;
...
public class StudentService {
    ...
    public Student updateStudent(int id, String dreamJob) {
        ...
        // Optional
        // null 일 가능성이 있는 객체를 감싸 놓은 객체 
        // 감싼 객체가 null 인 경우에 대한 처리를 위한 기능
        // null 인 상태에서 객체를 다룰때, NullPointerException의 위험을 줄이기 위한 용도
        // null 일 수 있는 객체를 리턴하는 메소드에서 리턴타입으로 활용
        // (내가 만든 메소드가 null 을 리턴할 수도 있으니 조심해서 다뤄라)
